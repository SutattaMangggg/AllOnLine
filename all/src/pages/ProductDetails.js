...
const ProductDetails = () => {
  ...
  if (!product){
    return (
      <section className='h-screen flex jutify-center items-center'>
        Loading...
      </section>
    );
  }

  const { product_name, sell_price, image, category, subcategory } = product;
  return (
    ...
    <div className='container mx-auto'>
      <div className='flex flex-col lg:flex-row items-center'>
        ...
        <div className='flex-1 text-center lg:text-left'>
          ...
          <p className='mb-8'>{category} - {subcategory}</p>
